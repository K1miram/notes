...
public class NotesClient {
    ...
    public static void saveNote(ItemStack stack, InteractionHand hand) {
        PacketDistributor.sendToServer(new SaveNoteC2SPayload(stack, hand));
    }

    public static void finalizeNote(ItemStack stack, InteractionHand hand) {
        PacketDistributor.sendToServer(new FinalizeNoteC2SPayload(stack, hand));
    }
    ...
    public static void openNotebook(ItemStack stack, InteractionHand hand, ResourceLocation id) {
    ...
    public static void removePage(InteractionHand hand, int pageIndex) {
        PacketDistributor.sendToServer(new RemovePageFromNotebookC2SPayload(hand, pageIndex));
    }

    public static void finalizeNotebook(InteractionHand hand) {
        PacketDistributor.sendToServer(new FinalizeNotebookC2SPayload(hand));
    }

    public static void openFinalizedNotebook(ItemStack stack, ResourceLocation id) {
